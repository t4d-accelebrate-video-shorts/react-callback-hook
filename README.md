...
### Improve React Functional Component Performance with Callback Hooks

[![YouTube Video](https://img.youtube.com/vi/Bygxp3mR9I8/0.jpg)](https://www.youtube.com/watch?v=Bygxp3mR9I8)
...
The provided files are the start and finish files for the video. If you desire to code along with the instructor, [Eric Greene](http://www.t4d.io), clone this repository, open the `start` folder in your code editor and get started with the [YouTube Video](https://www.youtube.com/watch?v=Bygxp3mR9I8). If you prefer to review only the completed files then browse the `finish` folder. 
...
```
git clone https://github.com/t4d-accelebrate-video-shorts/react-callback-hook.git
```
...
**Step 6.** Start watching the [YouTube Video](https://www.youtube.com/watch?v=Bygxp3mR9I8) and code along to learn more about how to improve React functional component performance with React's Callback Hook
