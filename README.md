...
**Step 6.** Start watching the [YouTube Video](#) and code along to learn more about how to improve React functional component performance with React's Callback Hook
